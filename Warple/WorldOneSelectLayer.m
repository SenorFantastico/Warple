...
@implementation WorldOneSelectLayer
...
+(CCScene *) scene
{
	...
	WorldOneSelectLayer*layer = [WorldOneSelectLayer node];
...
-(void)loadLevel:(id)sender {
    ...
    [[CCDirector sharedDirector] replaceScene:[CCTransitionProgressRadialCW transitionWithDuration:.5 scene:[Game sceneWithLevelData:levelnumber mapWorldNum:worldnumber]]];
}
-(void)PlaceGems:(NSMutableArray *)LevelMenuItems{
    ...
    for (CCMenuItemImage *levelMenuButton in LevelMenuItems){
        ...
        int GemsGained = [defualts integerForKey:tempstring];
        CCSprite *Gem1;
        CCSprite *Gem2;
        CCSprite *Gem3;
        switch (GemsGained) {
...
-(void)placeLevelSelect{
    ...
    if(isRetina){
        ...
        CCLabelTTF *Level1Label = [CCLabelTTF labelWithString:@" 1 " fontName:@"ArtBrush" fontSize:30];
        Level1Label.position =ccp(Level1.contentSize.width/2, Level1.contentSize.height/2);
        [Level1 addChild:Level1Label];
        Level1.userData = (__bridge void *)(@"1.1");
        ...
        CCLabelTTF *Level2Label = [CCLabelTTF labelWithString:@" 2 " fontName:@"ArtBrush" fontSize:30];
        Level2Label.position =ccp(Level2.contentSize.width/2, Level2.contentSize.height/2);
        [Level2 addChild:Level2Label];
        Level2.userData = (__bridge void *)(@"1.2");
        ...
        CCLabelTTF *Level3Label = [CCLabelTTF labelWithString:@" 3 " fontName:@"ArtBrush" fontSize:30];
        Level3Label.position =ccp(Level3.contentSize.width/2, Level3.contentSize.height/2);
        [Level3 addChild:Level3Label];
        Level3.userData = (__bridge void *)(@"1.3");
    ...
    CCLabelTTF *Level4Label = [CCLabelTTF labelWithString:@" 4 " fontName:@"ArtBrush" fontSize:30];
    Level4Label.position =ccp(Level4.contentSize.width/2, Level4.contentSize.height/2);
    [Level4 addChild:Level4Label];
    Level4.userData = (__bridge void *)(@"1.4");
    ...
    CCLabelTTF *Level5Label = [CCLabelTTF labelWithString:@" 5 " fontName:@"ArtBrush" fontSize:30];
    Level5Label.position =ccp(Level5.contentSize.width/2, Level5.contentSize.height/2);
    [Level5 addChild:Level5Label];
    Level5.userData = (__bridge void *)(@"1.5");
    ...
    CCLabelTTF *Level6Label = [CCLabelTTF labelWithString:@" 6 " fontName:@"ArtBrush" fontSize:30];
    Level6Label.position =ccp(Level6.contentSize.width/2, Level6.contentSize.height/2);
    [Level6 addChild:Level6Label];
    Level6.userData = (__bridge void *)(@"1.6");
    ...
    CCLabelTTF *Level7Label = [CCLabelTTF labelWithString:@" 7 " fontName:@"ArtBrush" fontSize:30];
    Level7Label.position =ccp(Level7.contentSize.width/2, Level7.contentSize.height/2);
    [Level7 addChild:Level7Label];
    Level7.userData = (__bridge void *)(@"1.7");
    ...
    CCLabelTTF *Level8Label = [CCLabelTTF labelWithString:@" 8 " fontName:@"ArtBrush" fontSize:30];
    Level8Label.position =ccp(Level8.contentSize.width/2, Level8.contentSize.height/2);
    [Level8 addChild:Level8Label];
    Level8.userData = (__bridge void *)(@"1.8");
    ...
    CCLabelTTF *Level9Label = [CCLabelTTF labelWithString:@" 9 " fontName:@"ArtBrush" fontSize:30];
    Level9Label.position =ccp(Level9.contentSize.width/2, Level9.contentSize.height/2);
    [Level9 addChild:Level9Label];
    Level9.userData = (__bridge void *)(@"1.9");
    ...
    CCLabelTTF *Level10Label = [CCLabelTTF labelWithString:@" 10 " fontName:@"ArtBrush" fontSize:30];
    Level10Label.position =ccp(Level10.contentSize.width/2, Level10.contentSize.height/2);
    [Level10 addChild:Level10Label];
    Level10.userData = (__bridge void *)(@"1.10");
    ...
    CCLabelTTF *Level11Label = [CCLabelTTF labelWithString:@" 11 " fontName:@"ArtBrush" fontSize:30];
    Level11Label.position =ccp(Level11.contentSize.width/2, Level11.contentSize.height/2);
    [Level11 addChild:Level11Label];
    Level11.userData = (__bridge void *)(@"1.11");
    ...
    CCLabelTTF *Level12Label = [CCLabelTTF labelWithString:@" 12 " fontName:@"ArtBrush" fontSize:30];
    Level12Label.position =ccp(Level12.contentSize.width/2, Level12.contentSize.height/2);
    [Level12 addChild:Level12Label];
    Level12.userData = (__bridge void *)(@"1.12");
    ...
    CCLabelTTF *Level13Label = [CCLabelTTF labelWithString:@" 13 " fontName:@"ArtBrush" fontSize:30];
    Level13Label.position =ccp(Level13.contentSize.width/2, Level13.contentSize.height/2);
    [Level13 addChild:Level13Label];
    Level13.userData = (__bridge void *)(@"1.13");
    ...
    CCLabelTTF *Level14Label = [CCLabelTTF labelWithString:@" 14 " fontName:@"ArtBrush" fontSize:30];
    Level14Label.position =ccp(Level14.contentSize.width/2, Level14.contentSize.height/2);
    [Level14 addChild:Level14Label];
    Level14.userData = (__bridge void *)(@"1.14");
    ...
    CCLabelTTF *Level15Label = [CCLabelTTF labelWithString:@" 15 " fontName:@"ArtBrush" fontSize:30];
    Level15Label.position =ccp(Level15.contentSize.width/2, Level15.contentSize.height/2);
    [Level15 addChild:Level15Label];
    Level15.userData = (__bridge void *)(@"1.15");
